  ...
  return (
    <div className="max-w-md mx-auto p-6 rounded-2xl border bg-white/80 dark:bg-gray-800/80 shadow">
      ...
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
        <div>
          <label htmlFor={nameId} className="block text-sm mb-1 text-gray-700 dark:text-gray-200">
            Name
          </label>
          <input
            id={nameId}
          ...
          />
          {errors.name && (
            <p id={nameErrId} className="text-sm text-red-500 mt-1" aria-live="polite">
              {errors.name.message}
            </p>
          )}
        </div>
        ...
        <div>
          <label htmlFor={confirmPasswordId} className="block text-sm mb-1 text-gray-700 dark:text-gray-200">
            Confirm Password
          </label>
          <input
          ...
          {errors.confirmPassword && (
            <p id={confirmErrId} className="text-sm text-red-500 mt-1" aria-live="polite">
