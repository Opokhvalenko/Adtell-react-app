...
export default function Footer() {
	...
	return (
		<footer className="relative isolate overflow-hidden bg-gradient-to-br from-slate-100 via-emerald-50 to-cyan-50 dark:bg-transparent dark:from-transparent dark:via-transparent dark:to-transparent shadow-2xl w-full">
			...
			<div className="pointer-events-none absolute top-0 left-0 w-full h-1 -z-10 bg-gradient-to-r from-transparent via-cyan-500/40 to-transparent mt-1" />
			<div className="pointer-events-none absolute top-0 left-0 w-full h-1 -z-10 bg-gradient-to-r from-transparent via-emerald-500/30 to-transparent mt-1.5" />
			<div className="pointer-events-none absolute top-8 right-8 w-40 h-40 -z-10 bg-gradient-to-br from-emerald-400/20 to-cyan-400/20 rounded-full blur-3xl" />
			<div className="pointer-events-none absolute bottom-8 left-8 w-32 h-32 -z-10 bg-gradient-to-tr from-teal-400/20 to-cyan-400/20 rounded-full blur-2xl" />
			<div className="pointer-events-none absolute top-1/2 left-1/2 -z-10 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-gradient-to-r from-cyan-400/10 to-emerald-400/10 rounded-full blur-3xl" />

			<div className="relative z-10 w-full">
				<div className="max-w-7xl mx-auto px-6 py-16">
					<section className="relative grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
						<div className="pointer-events-none absolute -bottom-6 left-0 right-0 h-1 -z-10 bg-gradient-to-r from-transparent via-emerald-400/50 to-transparent" />
						<div className="pointer-events-none absolute -bottom-6 left-0 right-0 h-1 -z-10 bg-gradient-to-r from-transparent via-teal-400/40 to-transparent mt-0.5" />

						<div className="lg:col-span-2">
							<div className="flex items-center gap-4 mb-6">
								<div className="w-14 h-14 bg-gradient-to-r from-emerald-500 via-teal-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-2xl">
						...
						<nav>
							...
							<div className="space-y-4">
								<Link
									to="/"
									className="flex items-center gap-3 text-sm text-gray-800 dark:text-gray-200 hover:text-blue-600 dark:hover:text-blue-400 transition-colors p-2 rounded-lg hover:bg-white/50 dark:hover:bg-gray-600/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2 ring-offset-white dark:ring-offset-gray-800"
								>
					...
					<section className="pt-8 relative">
						<div className="pointer-events-none absolute top-0 left-0 right-0 h-1 -z-10 bg-gradient-to-r from-transparent via-gray-400/60 to-transparent dark:via-gray-500/60" />
						<div className="pointer-events-none absolute top-0 left-0 right-0 h-1 -z-10 bg-gradient-to-r from-transparent via-emerald-300/40 to-transparent dark:via-emerald-400/40 mt-0.5" />
